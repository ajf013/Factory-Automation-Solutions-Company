        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white border border-black/5 flex items-center justify-center text-gray-700 hover:text-blue-600 hover:border-blue-600/30 transition-all shadow-sm">
                <Globe size={18} />
              </a>
              ...
              <a href="https://www.linkedin.com/company/fasco-pvt-ltd-robotic-automation-systems/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white border border-black/5 flex items-center justify-center text-gray-700 hover:text-blue-600 hover:border-blue-600/30 transition-all shadow-sm">
          ...
          {/* We Serve Column */}
          <div>
            <h4 className="text-gray-900 font-bold text-xs uppercase tracking-widest mb-8 border-b border-blue-600/10 pb-2 w-fit">We Serve</h4>
            <ul className="space-y-3">
              {industries.map((ind, i) => (
                <li key={i} className="text-gray-700 text-sm font-medium hover:text-blue-600 transition-colors cursor-default">{ind}</li>
              ))}
            </ul>
          </div>
          ...
          {/* Services Column */}
          <div>
            <h4 className="text-gray-900 font-bold text-xs uppercase tracking-widest mb-8 border-b border-blue-600/10 pb-2 w-fit">Services</h4>
            <ul className="space-y-3">
              {services.map((s, i) => (
                <li key={i}>
                  <Link href={s.href} className="text-gray-700 text-sm font-medium hover:text-blue-600 transition-colors">{s.name}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Get In Touch Column */}
          <div>
            <h4 className="text-gray-900 font-bold text-xs uppercase tracking-widest mb-8 border-b border-blue-600/10 pb-2 w-fit">Get In Touch</h4>
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:sales@fascoindia.com" className="text-gray-700 text-sm font-bold hover:text-blue-600 transition-colors">sales@fascoindia.com</a>
              </div>
            </div>
          </div>
        </div>
